					...
					<div class="HeaderPc__HeaderMenu-nc9k3i-0 eLvPLs" style="    border-bottom: 1px solid #393939;">
						<div class="Common__Container-sc-1immaas-1 dkajRY container">
							<div class="menu-group">
								<a class="logo empty-appconf" href="/"><img class="logoImg" src="/resources/assets/img/logo.png" alt="logo"></a>
								<nav class="Nav__NavWrapper-zfpvto-0 ekGCiX device-pc">
									<ul>
									  
										<li><a class="name " href="../index">홈</a></li>
										<li><a class="name " href="/contentsList">전체보기</a></li>
							...
							<a class="search" href="/search">검색하기</a>
						</div>
					</div>
				</div>
			</div>
