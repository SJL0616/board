	...
	$.ajax({
	 ...
	 success : function(data, textStatus, jqXHR){
		 ...
		 $.each(data, function(index, item){
			replyText += "<li class='left clearfix'>"
					 +"<div><div class='header'><strong class='primary-font' id='replyer'>["+item.rno+"] "+item.replyer+"</strong>"
				     + "<small class='pull-right text-muted' id='date'>"+item.updatedate+"</small></div>"
				     +"<p id='commment'>"+item.reply+"</p></div></li>";
